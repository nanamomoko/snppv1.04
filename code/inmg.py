...
def input_mag_model(targetmag,galtpl,deltal, filtera,specsample):
  ...
  ####################################################################################
    ...
    sampling=specsample #pixels per spectral resolution element ?1D or 2D/linear or area?
    print('sampling:', sampling)

    delta_lambda=deltal # has to be in unit of A
...
##################################################################
    return wavearr, galflux, integconst
