...
#####################################################################################
class snpp(object):
    def __init__(self, wavearr=False,galflux=False,integconst=False,
                 filename=False,deltal=1.755555, filtera=False,
                 readnoise=4.0,fovp=0.2,npixel_width=2.0,
                 obstime=300,repeatnum=1.0,skyv=22.5, qinput=1.0,
                 specsample=2.0,slitwidth=None,skyperpixel=False):
        ...
        iskyv0=skyv  # in Johnson V mag/arcsec^2 unit
        print('skyv:', iskyv0)
        ...
        for i in range(narray):
            ...
            delta_hz=cc*delta_lambda[i]/lambda0/lambda0 #;10^18 1/s
